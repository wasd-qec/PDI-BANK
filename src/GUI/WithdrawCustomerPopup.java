...
public class WithdrawCustomerPopup extends JDialog {

    public WithdrawCustomerPopup(JFrame parent) {
        super(parent, true);
        ...
        withdrawBtn.setBounds(285, 200, 120, 40);
        panel.add(withdrawBtn);

        // Cancel just closes popup
        cancelBtn.addActionListener(e -> dispose());

        // Withdraw closes + shows success popup
        withdrawBtn.addActionListener(e -> {
            dispose(); // close withdraw popup
            new SuccesPopupCustomerWD(parent); // show success popup
        });
