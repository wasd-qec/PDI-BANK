...
public class SuccesPopupCustomerTS extends JDialog {

    public SuccesPopupCustomerTS(JFrame parent) {
        ...
        JLabel msg = new JLabel("Transfer Successful!", SwingConstants.CENTER);
