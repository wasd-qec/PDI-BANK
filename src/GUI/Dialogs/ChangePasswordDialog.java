...
import Presentation.Controller.CustomerSecurityController;
import GUI.Components.RoundedButton;

/**
 * Change password dialog
 * Dialogs layer: Allows customer to change their password
 */
public class ChangePasswordDialog extends JDialog {
    ...
    private final CustomerSecurityController securityController = new CustomerSecurityController();
    ...
    private void handleChangePassword() {
        ...
        if (!securityController.validateOldPassword(customer.getAccNo(), oldPassword)) {
        ...
        try {
            securityController.changePassword(customer, newPassword);
            dispose();
