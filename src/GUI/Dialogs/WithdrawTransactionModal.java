...
/**
 * Withdraw transaction modal dialog
 * Dialogs layer: Allows user to create withdrawal transactions
 */
    ...
    public WithdrawTransactionModal(JFrame parent) {
        ...
        createBtn.addActionListener(e -> {
            ...
            try {
                ...
                Customer customer = transactionController.findCustomerByAccNo(accNo).orElse(null);
                if (customer == null) {
                ...
                Transaction result = transactionController.processWithdrawal(customer, amount);
                if (result != null) {
                    dispose();
