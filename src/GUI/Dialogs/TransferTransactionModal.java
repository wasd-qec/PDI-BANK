...
/**
 * Transfer transaction modal dialog
 * Dialogs layer: Allows user to create transfer transactions between accounts
 */
    ...
    public TransferTransactionModal(JFrame parent) {
        ...
        createBtn.addActionListener(e -> {
            ...
            try {
                ...
                Customer sender = transactionController.findCustomerByAccNo(senderAccNo).orElse(null);
                if (sender == null) {
                ...
                Customer receiver = transactionController.findCustomerByAccNo(receiverAccNo).orElse(null);
                if (receiver == null) {
                ...
                Transaction result = transactionController.processTransfer(sender, receiver, amount);
                if (result != null) {
                    dispose();
