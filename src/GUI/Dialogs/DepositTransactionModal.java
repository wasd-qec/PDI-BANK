...
/**
 * Deposit transaction modal dialog
 * Dialogs layer: Allows user to create deposit transactions
 */
    ...
    public DepositTransactionModal(JFrame parent) {
        ...
        createBtn.addActionListener(e -> {
            ...
            try {
                ...
                Transaction result = transactionController.processDeposit(customer, amount);
                if (result != null) {
                    dispose();
